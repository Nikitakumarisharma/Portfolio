    ...
    <div className="grid lg:grid-cols-2 grid-cols-1 bg-black text-white">
      ...
      <section id="experience" className="experience-section pb-4">
        ...
        <div className="experience-item mb-4 bg-teal-500 text-white rounded-2xl lg:mx-4 mx-2 p-4 pb-2">
          <h4 className="text-2xl">Frontend Developer Intern <span className="text-teal-700 text-[15px] ml-2">(May 2024 – July 2024)</span>
          </h4>
        ...
        <div className="experience-item mb-4 bg-teal-500 text-white rounded-2xl lg:mx-4 mx-2 p-4 pb-2">
          <h4 className="text-2xl">Software Development Intern<span className="text-teal-700 text-[15px] ml-2">(July 2023 - August 2023)</span>
          </h4>
        ...
        <div className="experience-item mb-4 bg-teal-500 text-white rounded-2xl lg:mx-4 mx-2 p-4 pb-2 ">
          <h4 className="text-xl">Open-Source Contributor <span className="text-teal-700 text-[15px] ml-2">(June 2024 - august 2024)</span>
          </h4>
